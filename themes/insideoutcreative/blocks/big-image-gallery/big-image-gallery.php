...
echo '<div class="big-image-gallery owl-carousel owl-theme arrows-middle">';

$workImages = get_field('big_image_gallery');
...
echo '<a href="' . wp_get_attachment_image_url($workImage['id'], 'full') . '" data-lightbox="big-image-gallery">';
echo wp_get_attachment_image($workImage['id'], 'full','',[
	'class'=>'w-100 big-image-gallery',
	'style'=>'height:600px;object-fit:cover;min-height:83vh;'
] );
